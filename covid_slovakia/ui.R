    ...
    mainPanel(
      tabsetPanel(id = "tabb",
        tabPanel(title = "Fit",
          ...
          br(),
          br(),
          h4("Simulated actual numbers of people with intensities above 3 thresholds: 0, 0.25 and 0.5. Above threshold 0 are all symptomatically infected, over 0.25 prisoners and over 0.5 dead"),

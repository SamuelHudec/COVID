    ...
    sidebarPanel(
      ...
      conditionalPanel(condition = "input.tabb == 'fitt'",
        numericInput(inputId ="pred",
                     label = "Počet dní pred fazou kedy začala efektivne epidemia",
                     value = 9,
                     min = 3,
                     max = 50,
                     step = 1),
      ...
      conditionalPanel(condition = "input.tabb == 'gridd'",
        ...
        sliderInput(inputId ="b0v",
                    label = "Parameter miery priznakov pre neinfikovanych",
                    value = c(100, 300),
                    min = 20,
                    max = 500,
                    step = b0v_step),

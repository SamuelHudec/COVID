    ...
    mainPanel(
      tabsetPanel(id = "tabb",
        tabPanel(title = "Model Fit",
          ...
          br(),
          br(),
          h4("Simulated cumulative course of the actual number of infected"),
          plotlyOutput("best_fit_2"),
          br(),
          br(),
          h4("Simulated actual numbers of people with intensity above threshold 0.5 are all symptomatically infected"),
          plotlyOutput("best_fit_31"),
          br(),
          br(),
          h4("Simulated actual numbers of people with intensity over 0.25 prisoners"),
          plotlyOutput("best_fit_32"),
          br(),
          br(),
          h4("Simulated actual numbers of people with intensity over 0 dead"),
          plotlyOutput("best_fit_33"),
          br(),
          br(),
          h4("Estimation of age distribution positively tested"),

---
title: "Theoretical and technical background"
...
More detail informations about model you can find in [paper](http://www.iam.fmph.uniba.sk/ospm/Harman/COR01.pdf).

# Engine

[Here](http://www.iam.fmph.uniba.sk/ospm/Harman/programs/corona_sim.txt) is last code, to be updated...
```{r script, echo=FALSE}
read_lines('model2.R')
```
